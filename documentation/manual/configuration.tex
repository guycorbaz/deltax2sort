...
and offset. The built-in default assumes the camera's optical centre maps
to the robot origin at 0.5\,mm/px for a 1280$\times$720 image. A guided
calibration wizard is planned (see the TODO list); until it exists, the
parameters in \cfg{src/vision/calibration.rs} must be adjusted to match
the physical camera mounting.

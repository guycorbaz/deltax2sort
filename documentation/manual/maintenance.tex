...
\begin{table}[h]
  ...
  \begin{tabularx}{\textwidth}{lD}
    ...
    \cfg{documentation/} & Specifications, this manual (sources under
      \cfg{documentation/manual/}), TODO list. \\
    \bottomrule
  \end{tabularx}
...
The manual sources live under \cfg{documentation/manual/}, one file per
chapter; \cfg{documentation/manual.tex} is the driver that sets the class
and includes them. Build with:
\begin{lstlisting}[language=bash]
cd documentation && latexmk -pdf manual.tex
\end{lstlisting}

\section{Remaining work}
\index{TODO list}\index{roadmap}%
The authoritative, maintained list of open work items lives in
\cfg{documentation/TODO.md}. Major open areas at the time of writing:

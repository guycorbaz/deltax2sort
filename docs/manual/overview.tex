...
\begin{description}[style=nextline]
  ...
  \item[Vision layer (\cfg{src/vision/})]
    ...
    calibration (affine transform with rotation), an object tracker and a
    classifier. Tracker and classifier are still placeholder
    implementations (see the project TODO list).

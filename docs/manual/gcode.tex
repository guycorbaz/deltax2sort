...
\begin{notebox}
  ...
  trajectory planner --- see \cfg{docs/TODO.md}).
\end{notebox}
...
\begin{itemize}
  \item \cfg{G90}: interpret subsequent coordinates as absolute positions
    relative to the origin. The application forces this mode at the end of
    every connection --- before any move can be issued and regardless of
    \cfg{home\_on\_connect} --- and re-asserts it after homing. All
    \cfg{G01} moves and the workspace safety check assume absolute
    coordinates.
